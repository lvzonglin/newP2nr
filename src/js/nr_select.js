...
define(function (require, exports, module) {
    ...
    function selectFx(domNode,settings){
        this.isField = true;
        this.down = false;
        this.inFocus = false;
        this.disabled = false;
    ...
    selectFx.prototype = {
        ...
        render: function(){
            ...
            self.$container = self.$select.wrap('<div class="'+self.wrapperClass+disabledClass+'"><span class="old"/></div>').parent().parent();
